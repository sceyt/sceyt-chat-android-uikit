...
import com.sceyt.chatuikit.styles.extensions.create_channel.buildImageCropperStyle
...
data class CreateChannelStyle(
        ...
        val imageCropperStyle: ImageCropperStyle,
) {
    companion object {
        ...
        fun build(): CreateChannelStyle {
            context.obtainStyledAttributes(attrs, R.styleable.CreateChannel).use { array ->
                ...
                return CreateChannelStyle(
                    ...
                    imageCropperStyle = buildImageCropperStyle(array),
                )
            }
        }
    }
