...
data class SceytMessage(
        ...
        val user: User?,
        val attachments: Array<SceytAttachment>?,
        val userReactions: Array<SceytReaction>?,
        val reactionTotals: Array<ReactionTotal>?,
        val markerTotals: Array<MarkerTotal>?,
        val userMarkers: Array<SceytMarker>?,
        val mentionedUsers: Array<User>?,
