package com.sceyt.chatuikit.presentation.uicomponents.changerole
...
import com.sceyt.chatuikit.presentation.uicomponents.changerole.adapter.ChooseRoleAdapter
import com.sceyt.chatuikit.presentation.uicomponents.changerole.adapter.RoleItem
import com.sceyt.chatuikit.presentation.uicomponents.changerole.viewmodel.RoleViewModel

class SceytChangeRoleActivity : AppCompatActivity() {
    ...
    companion object {
        ...
        fun newInstance(context: Context, member: SceytMember): Intent {
            return Intent(context, SceytChangeRoleActivity::class.java).apply {
