package com.sceyt.chatuikit.presentation.uicomponents.addmembers
...
import com.sceyt.chatuikit.presentation.uicomponents.addmembers.adapters.SelectedUsersAdapter
import com.sceyt.chatuikit.presentation.uicomponents.addmembers.adapters.UserItem
import com.sceyt.chatuikit.presentation.uicomponents.addmembers.adapters.viewholders.SelectableUserViewHolderFactory
...
class SceytAddMembersActivity : AppCompatActivity() {
    ...
    private fun SceytActivityAddMembersBinding.applyStyle() {
    ...
    companion object {
        ...
        fun newInstance(context: Context,
            ...
            return Intent(context, SceytAddMembersActivity::class.java).apply {
