...
class OutSelfDestructedMessageViewHolder(
    private val binding: SceytItemOutSelfDestructedMessageBinding,
    private val viewPool: RecyclerView.RecycledViewPool,
    private val style: MessageItemStyle,
    private val messageListeners: MessageClickListeners.ClickListeners?,
    needMediaDataCallback: ((NeedMediaInfoData) -> Unit)? = null,
) : BaseMessageViewHolder(binding.root, style, messageListeners, needMediaDataCallback = needMediaDataCallback) {
    ...
    private fun SceytItemOutSelfDestructedMessageBinding.setMessageItemStyle() {
