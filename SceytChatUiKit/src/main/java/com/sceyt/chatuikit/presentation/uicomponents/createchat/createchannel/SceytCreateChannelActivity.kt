package com.sceyt.chatuikit.presentation.uicomponents.createchat.createchannel
...
class SceytCreateChannelActivity : AppCompatActivity() {
    ...
    private fun initViewModel() {
        viewModel.createChatLiveData.observe(this) {
            lifecycleScope.launch {
                createdChannel = it
                val animOptions = ActivityOptionsCompat.makeCustomAnimation(this@SceytCreateChannelActivity,
                ...
                addMembersActivityLauncher.launch(
                    SceytAddMembersActivity.newInstance(
                        context = this@SceytCreateChannelActivity,
