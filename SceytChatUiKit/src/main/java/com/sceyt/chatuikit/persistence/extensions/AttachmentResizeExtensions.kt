...
fun transcodeVideo(context: Context, path: String?, quality: TranscodeQuality = TranscodeQuality.Medium,
    ...
    path?.let {
        ...
        VideoTranscodeHelper.transcodeAsResultWithCallback(context, destination = dest, path = it, quality) { data ->
