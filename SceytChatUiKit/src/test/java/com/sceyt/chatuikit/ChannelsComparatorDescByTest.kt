...
class ChannelsComparatorDescByTest {
    ...
    fun sort_channels_by_channel_created_at_without_pinned_at() {
        ...
        channels.sortWith(ChannelsComparatorDescBy(SceytChatUIKitConfig.ChannelSortType.ByChannelCreatedAt))
    ...
    fun sort_channels_by_last_message_createdAt() {
        ...
        channels.sortWith(ChannelsComparatorDescBy(SceytChatUIKitConfig.ChannelSortType.ByLastMsg))
