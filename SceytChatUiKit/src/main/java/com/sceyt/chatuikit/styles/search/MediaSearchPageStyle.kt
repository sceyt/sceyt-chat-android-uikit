...
data class MediaSearchPageStyle(
    ...
    internal class Builder(
        ...
        fun build(): MediaSearchPageStyle {
            return MediaSearchPageStyle(
                ...
                itemStyle = ChannelInfoMediaItemStyle.Builder(context, attrs).build(),
