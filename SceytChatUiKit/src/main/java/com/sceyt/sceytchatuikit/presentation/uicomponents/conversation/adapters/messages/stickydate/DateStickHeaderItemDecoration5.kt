...
class DateStickHeaderItemDecoration5(private val mListener: StickyHeaderInterface) : RecyclerView.ItemDecoration() {
    ...
    override fun onDrawOver(c: Canvas, parent: RecyclerView, state: RecyclerView.State) {
        ...
        if (verticalOffset > parent.paddingTop && !shoulsreturn) {
