...
class MessageLoadRangeUpdater(
    ...
    suspend fun getMessageLoadRange(channelId: Long, messageId: Long): List<LoadRangeEntity> {
        return loadRangeDao.getLoadRange(channelId = channelId, messageId = messageId)
    }
}